"""
This configuration file is mounted to be read by jupyterbook.pub with the sole purpose
...
def _read_chart_config():
    ...
    """
    yaml = YAML(typ="safe")
    with open("/etc/jupyterbook.pub/mounted-secret/chart-config.yaml") as f:
        return yaml.load(f)
...
def get_chart_config(config_path=None, default=None):
    ...
    section's path like "config.XXX".
    """
